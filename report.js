...
function generateTable(data, datetype) {
  ...
  if (datetype == "checking") {
    let table = `<table class="table"><thead><tr><th>FE Number</th><th>Coach Number</th><th>Build Date</th><th>Last Checking Date</th><th>Next Checking Date</th><th>Day\'s Pending</th></tr></thead><tbody>`;
    data.forEach((row) => {
      table += `<tr>
  ...
  if (datetype == "refilling") {
    let table = `<table class="table"><thead><tr><th>FE Number</th><th>Coach Number</th><th>Build Date</th><th>Last refilling Date</th><th>Next refilling Date</th><th>Day\'s Pending</th></tr></thead><tbody>`;
    data.forEach((row) => {
      table += `<tr>
          <td>${row.unique_number}</td>
          <td>${row.coach_number}</td>
  ...
  if (datetype == "hydralic") {
    let table = `<table class="table"><thead><tr><th>FE Number</th><th>Coach Number</th><th>Build Date</th><th>Last hydralic Date</th><th>Next hydralic Date</th><th>Day\'s Pending</th></tr></thead><tbody>`;
    data.forEach((row) => {
      table += `<tr>
          <td>${row.unique_number}</td>
          <td>${row.coach_number}</td>
