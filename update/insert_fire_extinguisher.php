...
<body>
  ...
  <div class="container mt-5">
    <div class="text-center text-white border border-primary bg-primary">
    ...
    <form action="" method="POST">
      <div class="form-row">
        <div class="col-md-6">
          <label for="uniqueNumber" class="form-label">FE Number</label>
        </div>
        <div class="col">
          <input
            type="text"
      ...
      <div class="mb-3">
        <label for="hydraulicTestDate" class="form-label">Hydraulic Test Date</label>
        <input
          type="date"
          class="form-control"
